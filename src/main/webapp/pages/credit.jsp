...
<div>
    ...
    <div class="page-content">
        ...
        %>
        <div class="container">
            <form action="../DataModifyServlet" method="post" style="width: 500px;margin: 100px auto;">
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="username" name="username" class="form-control" value="<%=user.getUsername()%>" disabled>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="tel" name="tel" class="form-control" value="<%=user.getTel()%>">
                </div>
                <button type="button" class="btn btn-danger"><a href="password-modify.jsp" style="text-decoration: none;color: black;">修改密码</a></button>
