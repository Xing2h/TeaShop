...
<div class="page-content">
    ...
    <div class="container">
        ...
        %>
        <form action="../../CommodityModifyServlet" style="width: 500px;margin: 0 auto;" method="post">
            <div class="form-group">
                <label for="img_show">商品图片</label>
                <img style="width: 350px;height: 350px;" id="img_show" src="../../static/img/tee/<%=commodity.getId()%>.jpg" alt="">
                <input type="file" onchange="imgChange();" style="margin: 0 0 0 200px;" id="img" placeholder="上传图片">
            </div>
            <div style="visibility: hidden;width: 0;height: 0;">
                <input type="text" name="id" value="<%=commodity.getId()%>">
            </div>
            <div class="form-group">
                <label for="name">商品名</label>
                <input type="text" id="name" name="name" class="form-control" value="<%=commodity.getName()%>">
            </div>
            <div class="form-group">
                <label for="type">商品类型</label>
                <input type="text" id="type" name="type" class="form-control" value="<%=commodity.getType()%>">
            </div>
            <div class="form-group">
                <label for="price">商品价格</label>
                <input type="text" id="price" name="price" class="form-control" value="<%=commodity.getPrice()%>">
            </div>
            <div class="form-group">
                <label for="num">库存</label>
                <input type="text" id="num" name="num" class="form-control" value="<%=commodity.getNum()%>">
            </div>
            <div class="form-group">
                <label for="origin">产地</label>
                <input type="text" id="origin" name="origin" class="form-control" value="<%=commodity.getOrigin()%>">
            </div>
            <div class="form-group">
                <label for="productiondate">生产日期</label>
                <input type="text" id="productiondate" name="productiondate" class="form-control" value="<%=commodity.getProductiondate()%>">
            </div>
            <div class="form-group">
                <label for="details">商品描述</label>
                <input type="text" id="details" name="details" class="form-control" value="<%=commodity.getDetails()%>">
            </div>
